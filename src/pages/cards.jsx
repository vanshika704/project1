function Cards(){
    ...
    <section>
        <div className="container max-w-full mx-auto py-24 px-6">
            <h1
            className="text-center text-4xl text-black font-medium leading-snug tracking-wider"
            >
            Pricing
        </h1>
        ...
        <div
        className="h-1 mx-auto bg-indigo-200 w-24 opacity-75 mt-4 rounded"
        ></div>
        ...
        <div className="max-w-full md:max-w-6xl mx-auto my-3 md:px-8">
            ...
            >
            <div
            className="bg-white text-black rounded-lg shadow-inner shadow-lg overflow-hidden"
            >
            <div
    ...
    <div
    className="w-full max-w-md sm:w-2/3 lg:w-1/3 sm:my-5 my-8 relative z-10 bg-white rounded-lg shadow-lg"
    >
    <div
